...
class RentalEndingGroup extends Mailable
{
    ...
    {
        $view = 'emails.' . $this->locale . '.user-notification.rental-ending-group';
        if(!view()->exists($view))
            $view = 'emails.'.config("api.default_language").'.user-notification.rental-ending-group';
