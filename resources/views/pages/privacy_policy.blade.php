...
@section("content")
    <main class="container mt-5 mb-5 regulations">
        ...
        <div>
            <h5 class="text-center mt-5">§1. Administrator danych osobowych</h5>
            <ol>
                <li>
                    Administratorem danych osobowych w rozumieniu art. 4 pkt 7 rozporządzenia Parlamentu Europejskiego i
                    ...
                    (RODO) jest Artur Patura wykonujący działalność gospodarczą pod firmą Artur Patura – netextend.pl pod
        ...
        <div>
            <h5 class="text-center mt-5">§2. Cel i podstawy przetwarzania danych osobowych</h5>
        
            <p class="mb-0">Administrator przetwarza dane osobowe w następujących celach:</p>
            <ol type="a">
                <li>
                ...
                <li>
                    zawieranie i realizacja umów z klientami, na podstawie zawartej umowy (art. 6 ust. 1 lit. b RODO);
                </li>
                <li>
                    świadczenie usług drogą elektroniczną za pośrednictwem stron internetowych, na podstawie
                ...
                <li>
                    marketing, co jest jego prawnie uzasadnionym interesem (art. 6 ust. 1 lit. f RODO) lub odbywa się na
        ...
        <div>
            <h5 class="text-center mt-5">§3. Odbiorcy danych. Przekazywanie danych do państw trzecich</h5>
            <ol>
                <li>
                ...
                <li>
                    Dane osobowe w związku z wykorzystywaniem przez administratora narzędzi do analizy i śledzenia ruchu na
                    stronie internetowej mogą zostać przekazane do podmiotu mającego siedzibę poza Europejskim Obszarem
                    Gospodarczym, np. do Google LLC lub do Meta Platforms Inc. Jako właściwy środek ochrony danych,
                    administrator danych zgodził się na standardowe klauzule umowne zgodnie z art. 46 RODO z dostawcami
                    tych usług. Więcej informacji na ten temat jest dostępnych tutaj: https://commission.europa.eu/law/law-
        ...
        <div>
            <h5 class="text-center mt-5">§4. Okres przechowywania danych osobowych</h5>
            <ol>
                <li>
                    Administrator danych przechowuje dane osobowe przez okres obowiązywania umowy zawartej z osobą,
                ...
                <li>
                    Administrator danych przechowuje dane osobowe znajdujące się na dokumentach rozliczeniowych przez
                    okres wskazany przepisami ustawy o podatku od towarów i usług oraz ustawą o rachunkowości.
                </li>
                <li>
                    Administrator danych przechowuje dane osobowe przetwarzane w celach marketingowych przez okres lat
                    10, jednak nie dalej niż do momentu wycofania zgody na przetwarzanie danych lub wniesienia sprzeciwu
                    wobec przetwarzania danych.
                </li>
                <li>
                    Administrator danych przechowuje dane osobowe w celach innych niż wskazane w ust. 1-3 przez okres
        ...
        <div>
            <h5 class="text-center mt-5">§5. Uprawnienia osoby, której dane dotyczą</h5>
            <ol>
                <li>
                    1. Każda osoba, której dane dotyczą, ma prawo:
                    <ol type="a">
                        <li>
                            <strong>dostępu</strong> – uzyskania od administratora potwierdzenia, czy przetwarzane są jej dane osobowe. Jeżeli dane
                        ...
                        <li>
                            <strong>do otrzymania kopii danych</strong> – uzyskania kopii danych podlegających przetwarzaniu, przy czym pierwsza
                        ...
                        <li>
                            <strong>do sprostowania</strong> – żądania sprostowania dotyczących jej danych osobowych, które są nieprawidłowe lub
                            uzupełnienia niekompletnych danych (art. 16 RODO);
                        </li>
                        <li>
                            <strong>do usunięcia danych</strong> – żądania usunięcia jej danych osobowych, jeżeli administrator nie ma już podstawy
                            prawnej do ich przetwarzania lub dane nie są już niezbędne do celów przetwarzania (art. 17 RODO);
                        </li>
                        <li>
                            <strong>do ograniczenia przetwarzania</strong> – żądania ograniczenia przetwarzania danych osobowych (art. 18
                            RODO), gdy:
                        ...
                        <li>
                            <strong>do przenoszenia danych</strong> – otrzymania w ustrukturyzowanym, powszechnie używanym formacie
                        ...
                        <li>
                            <strong>do sprzeciwu</strong> – wniesienia sprzeciwu wobec przetwarzania jej danych osobowych w prawnie
        ...
        <div>
            <h5 class="text-center mt-5">§6. Profilowanie</h5>
            <ol>
                <li>
                    Dane osobowe uzyskane przez administratora danych mogą zostać przetwarzane w sposób automatyczny –
                    w tym w formie profilowania. Profilowanie danych osobowych dokonywane przez administratora danych
                ...
                <li>
                    Automatyczne przetwarzanie danych dokonywane przez administratora danych nie rodzi dla osoby, której
                    dane dotyczą żadnych skutków prawnych. Osoba, której dane dotyczą może w każdym czasie wnieść
                    sprzeciw wobec zautomatyzowanego przetwarzania jej danych.
                </li>
            </ol>
        </div>
            
        <div>
            <h5 class="text-center mt-5">§7. Google Analytics<h5></h5>
            <ol>
                <li>
                    Administrator używa Google Analytics, internetową usługę analityczną dostarczaną przez Google Inc. z
                    siedzibą w USA.
                </li>
                <li>
                    Google Analytics używa plików cookie, które umożliwiają analizę korzystania przez użytkownika ze strony
                    ...
                    na temat aktywności na stronie oraz świadczenia innych usług związanych z korzystaniem ze strony i
                    Internetu na rzecz podmiotu zlecającego.
                </li>
                <li>
                    Dane nie będą wykorzystywane do celów identyfikacji jakiejkolwiek osoby fizycznej.
                </li>
                <li>
                    Użytkownik może uniemożliwić zapisywanie plików cookie poprzez odpowiednie ustawienia przeglądarki;
                    jednak w takim wypadku nie będzie mógł korzystać z pełnej funkcjonalności strony. Ponadto użytkownicy
                    mogą uniemożliwić gromadzenie przez Google danych wytworzonych przez pliki cookie oraz odnoszących
                    się do ich korzystania z serwisu internetowego (łącznie z adresem IP) jak i przetwarzanie tych danych przez
                    Google, pobierając i instalując wtyczkę do przeglądarki dostępną pod następującym linkiem:
                    <a href="https://tools.google.com/dlpage/gaoptout?hl=pl" target="_blank">https://tools.google.com/dlpage/gaoptout?hl=pl</a>.
                </li>
                <li>
                    W każdym momencie użytkownik może zgłosić sprzeciw wobec gromadzenia oraz przetwarzania danych
                    związanych z użytkowaniem strony Google poprzez pobranie oraz instalację wtyczki w przeglądarce, która
                    jest dostępna pod następującym adresem: <a href="https://tools.google.com/dlpage/gaoptout?hl=en" target="_blank">https://tools.google.com/dlpage/gaoptout?hl=en</a>.
                </li>
            </ol>
        </div>
            
        <div>
            <h5 class="text-center mt-5">§8. Piksel Facebook</h5>
            <ol>
                <li>
                    Administrator korzysta z Piksel Facebook, narzędzia analitycznego, które pomaga mierzyć skuteczność
                    reklam na podstawie analizy działań podejmowanych przez użytkowników w witrynie.
                </li>
                <li>
                    Administrator korzysta z narzędzia Piksel Facebook w celu kierowania do Klienta spersonalizowanych
                    reklam w serwisie Facebook. Wiąże się to z wykorzystywaniem plików cookies firmy Facebook. Podstawę
                    prawną dla korzystania z narzędzia Piksel Facebook przez Administratora stanowi art. 6 ust. 1 lit. f RODO.
                </li>
            </ol>
        </div>
