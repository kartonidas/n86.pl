...
@section("content")
    <main class="container mt-5 mb-5 regulations">
        ...
        <ol>
            <li>
                Strona internetowa nie zbiera w sposób automatyczny żadnych informacji, z wyjątkiem informacji zawartych
                w plikach cookies.
            </li>
            <li>
                Pliki cookies (tzw. &quot;ciasteczka&quot;) stanowią dane informatyczne, w szczególności pliki tekstowe, które
                przechowywane są w urządzeniu końcowym użytkownika i przeznaczone są do korzystania ze stron
                internetowych. Cookies zazwyczaj zawierają nazwę strony internetowej z której pochodzą, czas
                przechowywania ich na urządzeniu końcowym oraz unikalny numer.
            </li>
            <li>
                Podmiotem zamieszczającym na urządzeniu końcowym użytkownika pliki cookies oraz uzyskującym do nich
                dostęp jest Artur Patura – netextend.pl.
            </li>
            <li>
                ...
                <ol type="a">
                    ...
                    <li>
                        utrzymanie sesji użytkownika w celu umożliwienia powrotu do zawartości koszyka.
                    </li>
                </ol>
            </li>
            <li>
                ...
                <ol type="a">
                    ...
                    <li>
                        ...
                        w zakresie uwierzytelniania w ramach strony internetowej; 
                    </li>
                    <li>
            ...
            <li>
                ...
                są w ustawieniach oprogramowania (przeglądarki internetowej) oraz zostały opisane tutaj:
                <ol type="a">
                    <li><a href="https://help.opera.com/pl/latest/web-preferences/" target="_blank">Przeglądarka Opera</a>,</li>
                    <li><a href="https://support.mozilla.org/pl/kb/wzmocniona-ochrona-przed-sledzeniem-firefox-desktop?redirectslug=W%C5%82%C4%85czanie+i+wy%C5%82%C4%85czanie+obs%C5%82ugi+ciasteczek&amp;redirectlocale=pl" target="_blank">Przeglądarka Firefox</a>,</li>
                    <li><a href="https://support.google.com/chrome/answer/95647?hl=pl" target="_blank">Przeglądarka Chrome</a>,</li>
                    <li><a href="https://support.microsoft.com/pl-pl/windows/usuwanie-plik%C3%B3w-cookie-i-zarz%C4%85dzanie-nimi-168dab11-0753-043d-7c16-ede5947fc64d" target="_blank">Przeglądarka Microsoft Edge</a>,</li>
                    <li><a href="https://support.apple.com/pl-pl/guide/safari/sfri11471/mac" target="_blank">Przeglądarka Safari</a>.</li>
                </ol>
            </li>
            <li>
