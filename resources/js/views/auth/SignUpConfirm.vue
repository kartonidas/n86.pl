    ...
    <div class="w-full py-6 px-5 sm:px-8">
        <div>
                ...
                <div class="p-fluid">
                    <div class="formgrid grid">
                        <div class="field col">
                            ...
                            <InputText id="firstname" type="text" :placeholder="$t('app.firstname')" class="w-full md:w-20rem" :class="{'p-invalid' : v$.firstname.$error}" v-model="firstname" />
                        ...
                        <div class="field col">
                            ...
                            <InputText id="lastname" type="text" :placeholder="$t('app.lastname')" class="w-full md:w-20rem" :class="{'p-invalid' : v$.lastname.$error}" v-model="lastname" />
            ...
            <div class="mb-4">
                <div class="formgrid grid">
                    <div class="field col">
                        ...
                        <InputText id="phone" type="text" :placeholder="$t('app.phone')" class="w-full md:w-20rem" :class="{'p-invalid' : v$.phone.$error}" v-model="phone" />
                    ...
                    <div class="field col">
                        ...
                        <InputText id="firm" type="text" :placeholder="$t('app.firm')" class="w-full md:w-20rem" :class="{'p-invalid' : v$.firm.$error}" v-model="firm" />
            ...
            <div class="mb-4">
                ...
                <Password id="confirm_password" v-model="confirm_password" :placeholder="$t('app.repeat_password')" :feedback="false" :class="{'p-invalid' : v$.confirm_password.$error}" :toggleMask="true" class="w-full" inputClass="w-full"></Password>
            ...
            <Button :label="$t('app.signup_confirm')" :loading="loading" iconPos="right" @click="confirm" class="w-full p-3 text-xl text-center"></Button>
        </div>
    </div>
</template>