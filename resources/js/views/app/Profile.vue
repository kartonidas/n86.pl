    ...
    <div class="grid mt-1">
        <div class="col">
            <div class="card p-fluid">
                <form v-on:submit.prevent="profileUpdate" class="sticky-footer-form">
                        ...
                        <div class="p-fluid">
                            <div class="formgrid grid">
                                <div class="field col-12 sm:col-6 mb-4">
                                    <label for="firstname" class="block text-900 font-medium mb-2" v-required>{{ $t('profile.firstname') }}</label>
                                ...
                                <div class="field col-12 sm:col-6 mb-4">
                                    <label for="lastname" class="block text-900 font-medium mb-2" v-required>{{ $t('profile.lastname') }}</label>
                                ...
                                <div class="field col-12 sm:col-6 mb-4">
                                    <label for="email" class="block text-900 font-medium mb-2" v-required>{{ $t('profile.email') }}</label>
                                ...
                                <div class="field col-12 sm:col-6 mb-4">
                                    ...
                                    <InputText id="phone" type="text" :placeholder="$t('profile.phone')" class="w-full" v-model="profile.phone" :disabled="loading || saving"/>
                                </div>
