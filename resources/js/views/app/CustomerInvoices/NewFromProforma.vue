<script>
    ...
    export default {
        ...
        setup() {
            setMetaTitle('meta.title.customer_invoices_from_proforma')
            ...
            return {
                ...
                meta: {
                    breadcrumbItems: [
                        ...
                        {'label' : this.$t('customer_invoices.new_invoice_from_proforma'), disabled : true },
                    ],
                }
            }
        },
            ...
            this.userInvoiceService.invoiceGet(this.$route.params.customerInvoiceId)
                .then(
                    (response) => {
                        ...
                        if (this.invoice.type != 'proforma' || !this.invoice.make_from_proforma) {
        ...
        methods: {
            async createInvoiceFromProforma() {
                this.saving = true
                this.errors = []
                ...
                this.userInvoiceService.invoiceCreateFromProforma(this.$route.params.customerInvoiceId, invoice)
                    .then(
                        (response) => {
