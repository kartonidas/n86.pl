<script>
    ...
    export default {
        ...
        methods: {
            getList() {
                this.loading = true
                this.customerService.list(this.meta.perPage, this.meta.currentPage, this.meta.sortField, this.meta.sortOrder, this.meta.search)
                    .then(
                        (response) => {
            ...
            <div class="card">
                ...
                <form v-on:submit.prevent="search">
                    <div class="formgrid grid mb-1">
                        ...
                        <div class="col-12 md:col-4 mb-3">
                            <InputText type="text" :placeholder="$t('customers.city')" class="w-full" v-model="meta.search.city"/>
                        </div>
                        
                        <div class="col-12 md:col-5 mb-3">
                            <InputText type="text" :placeholder="$t('customers.pesel')" class="w-full" v-model="meta.search.pesel"/>
                        </div>
                        
                        <div class="col-12 md:col-5 mb-3">
                            <InputText type="text" :placeholder="$t('customers.nip')" class="w-full" v-model="meta.search.nip"/>
                        </div>
