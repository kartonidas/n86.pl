        ...
        <div class="p-fluid">
            <div class="formgrid grid">
                ...
                <div class="field col-12 md:col-4 mb-4" v-if="customer.type == 'firm'">
                    ...
                    <InputText id="nip" type="text" :placeholder="$t('customers.nip')" class="w-full" v-model="customer.nip" :disabled="savin || loadingg" />
                </div>
                    ...
                    <div class="formgrid grid mt-3">
                        <div class="col-6 sm:col-4 md:col-3 xl:col-2">
                            <div class="flex align-items-center">
                                ...
                                <InputSwitch v-model="customer.send_sms" :trueValue="1"/>
                            </div>
                        </div>
                        <div class="col-6 sm:col-4 md:col-3 xl:col-2">
                            <div class="flex align-items-center">
                                <div class="mr-3">{{ $t('customers.email2') }}:</div>
                                <InputSwitch v-model="customer.send_email" :trueValue="1"/>
                            </div>
                        </div>
                    </div>
                </div>
