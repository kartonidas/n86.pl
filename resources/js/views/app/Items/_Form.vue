            ...
            <div class="p-fluid">
                <div class="formgrid grid">
                    <div class="field col-12 mb-4">
                        ...
                        <InputText id="name" type="text" :placeholder="$t('items.name')" class="w-full" :class="{'p-invalid' : v.item.name.$error}" v-model="item.name" :disabled="loading || saving || disabled"/>
                    ...
                    <div class="field col-12 md:col-4 mb-4">
                        ...
                        <Dropdown id="type" v-model="item.type" :options="settings.types" optionLabel="name" :class="{'p-invalid' : v.item.type.$error}" optionValue="id" :placeholder="$t('items.select_estate_type')" class="w-full" :disabled="loading || saving || disabled"/>
                    ...
                    <div class="field col-12 mb-4" :class="[item.ownership_type == 'manage' ? 'md:col-4 ' : 'md:col-8']">
                        ...
                        <Dropdown id="ownership_type" v-model="item.ownership_type" :class="{'p-invalid' : v.item.ownership_type.$error}" :options="settings.ownership_types" optionLabel="name" optionValue="id" :placeholder="$t('items.select_ownership_type')" class="w-full" :disabled="loading || saving || fromCustomer || disabled"/>
                    ...
                    <div class="field col-12 md:col-4 mb-4" v-if="item.ownership_type == 'manage'">
                        ...
                        <div class="flex">
                            <Dropdown v-model="item.customer_id" filter :options="settings.customers" :class="{'p-invalid' : v.item.customer_id.$error}" :style="[hasAccess('customer:create') ? 'width: calc(100% - 50px); margin-right: 10px;' : '']" optionLabel="name" optionValue="id" :placeholder="$t('items.select_customer')" class="w-full" :disabled="loading || saving || fromCustomer || disabled" />
                            <Button type="button" :loading="saving" v-tooltip.left="$t('items.add_customer')"  v-if="hasAccess('customer:create')" iconPos="right" @click="addCustomer" icon="pi pi-plus" class="p-button-secondary w-full text-center" style="min-width: 40px; max-width: 40px" :disabled="loading || saving || fromCustomer || disabled"></Button>
                        </div>
                ...
                <div class="formgrid grid ">
                    <div class="field col-12 md:col-6 mb-4">
                        ...
                        <InputText id="street" type="text" :placeholder="$t('items.street')" class="w-full" :class="{'p-invalid' : v.item.street.$error}" v-model="item.street" :disabled="loading || saving || disabled" />
                    ...
                    <div class="field col-12 md:col-3 sm:col-6 mb-4">
                        ...
                        <InputText id="house_no" type="text" :placeholder="$t('items.house_no')" class="w-full" :class="{'p-invalid' : v.item.house_no.$error}" v-model="item.house_no" :disabled="loading || saving || disabled" />
                    ...
                    <div class="field col-12 md:col-3 sm:col-6 mb-4">
                        ...
                        <InputText id="apartment_no" type="text" :placeholder="$t('items.apartment_no')" class="w-full" :class="{'p-invalid' : v.item.apartment_no.$error}" v-model="item.apartment_no" :disabled="loading || saving || disabled" />
                    ...
                    <div class="field col-12 md:col-4 sm:col-12 mb-4">
                        ...
                        <Dropdown id="country" v-model="item.country" filter :options="countries" optionLabel="name" optionValue="code" :placeholder="$t('items.select_country')" class="w-full" :disabled="loading || saving || disabled"/>
                    </div>
                    ...
                    <div class="field col-12 md:col-3 sm:col-4 mb-4">
                        ...
                        <InputText id="zip" type="text" :placeholder="$t('items.zip')" class="w-full" :class="{'p-invalid' : v.item.zip.$error}" v-model="item.zip" :disabled="loading || saving || disabled" />
                    ...
                    <div class="field col-12 md:col-5 sm:col-8 mb-4">
                        ...
                        <InputText id="city" type="text" :placeholder="$t('items.city')" class="w-full" :class="{'p-invalid' : v.item.city.$error}" v-model="item.city" :disabled="loading || saving || disabled" />
                ...
                <div class="formgrid grid ">
                    <div class="field col-12 md:col-3 sm:col-6 mb-4">
                        ...
                        <InputNumber id="area" :useGrouping="false" locale="pl-PL" :minFractionDigits="2" :maxFractionDigits="2" :placeholder="$t('items.area')" class="w-full" :class="{'p-invalid' : v.item.area.$error}" v-model="item.area" :disabled="loading || saving || disabled"/>
                    ...
                    <div class="field col-12 md:col-3 sm:col-6 mb-4">
                        ...
                        <InputNumber id="number_of_rooms" :useGrouping="false" locale="pl-PL" :placeholder="$t('items.number_of_rooms')" class="w-full" v-model="item.num_rooms" :class="{'p-invalid' : v.item.num_rooms.$error}" :disabled="loading || saving || disabled"/>
                    ...
                    <div class="field col-12 md:col-3 sm:col-6 mb-4">
                        ...
                        <InputNumber id="default_rent_value" :useGrouping="false" locale="pl-PL" :minFractionDigits="2" :maxFractionDigits="2" :placeholder="$t('items.default_rent_value')" class="w-full" :class="{'p-invalid' : v.item.default_rent.$error}" v-model="item.default_rent" :disabled="loading || saving || disabled"/>
                    ...
                    <div class="field col-12 md:col-3 sm:col-6 mb-4">
                        ...
                        <InputNumber id="default_deposit_value" :useGrouping="false" locale="pl-PL" :minFractionDigits="2" :maxFractionDigits="2" :placeholder="$t('items.default_deposit_value')" class="w-full" :class="{'p-invalid' : v.item.default_deposit.$error}" v-model="item.default_deposit" :disabled="loading || saving || disabled"/>
                    ...
                    <div class="field col-12 mb-4">
                        ...
                        <Textarea id="description" type="text" :placeholder="$t('items.description')" rows="3" class="w-full" :class="{'p-invalid' : v.item.description.$error}" v-model="item.description" :disabled="loading || saving || disabled"/>
                    ...
                    <div class="field col-12 mb-4">
                        ...
                        <Textarea id="comments" type="text" :placeholder="$t('items.comments')" rows="3" class="w-full" :class="{'p-invalid' : v.item.comments.$error}" v-model="item.comments" :disabled="loading || saving || disabled"/>
