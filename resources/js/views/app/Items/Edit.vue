            ...
            return {
                ...
                meta: {
                    breadcrumbItems: [
                        ...
                        {'label' : this.t('app.edit_item'), route : { name : 'items'}, disabled : true },
                    ],
                }
            }
        },
    ...
    <div class="grid mt-1">
        <div class="col">
            <div class="card p-fluid">
                ...
                <Button :label="$t('app.save')" v-if="!loading" :loading="saving" iconPos="right" @click="updateItem" class="w-auto text-center"></Button>
            </div>
        </div>
    </div>
</template>