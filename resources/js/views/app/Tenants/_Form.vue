...
<template>
        ...
        <div class="p-fluid">
            <div class="formgrid grid">
                ...
                <div class="field col-12 md:col-4 mb-4" v-if="tenant.type == 'firm'">
                    ...
                    <InputText id="nip" type="text" :placeholder="$t('tenants.nip')" class="w-full" v-model="tenant.nip" :disabled="savin || loadingg" />
                </div>
                    ...
                    <div class="formgrid grid mt-3">
                        <div class="col-6 sm:col-4 md:col-3 xl:col-2">
                            <div class="flex align-items-center">
                                ...
                                <InputSwitch v-model="tenant.send_sms" :trueValue="1"/>
                            </div>
                        </div>
                        <div class="col-6 sm:col-4 md:col-3 xl:col-2">
                            <div class="flex align-items-center">
                                <div class="mr-3">{{ $t('tenants.email2') }}:</div>
                                <InputSwitch v-model="tenant.send_email" :trueValue="1"/>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="mb-4">
        <div class="flex justify-content-between align-items-center header-border-bottom pb-2 ">
            <h5 class="inline-flex  mb-0">{{ $t('tenants.phone_list') }}</h5>
